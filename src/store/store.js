...
const rootreducer =  combineReducers({searchbar: searchReducer, slidebar:slidebarReducer , featuredbrand:FeaturedbrandReducer,popularcatogery:PopularcatogeryReducer,healthconcern:HealthconcernReducer,topnutritionseller:TopNutritionSellerReducer})
